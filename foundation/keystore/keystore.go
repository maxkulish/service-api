...
// of a dictionary. The name of each PEM file will be used as the key id.
// Example: keystore.NewFS(os.DirFS("/zarf/keys"))
// Example: /zarf/keys/59189175-db33-438d-8cc7-4abde89fbbe8.pem
func NewFS(fsys fs.FS) (*KeyStore, error) {
	...
	fn := func(fileName string, dirEntry fs.DirEntry, err error) error {
		...
		// Strip the .pem extension from the file name
		// and use that as the key id.
...
// PrivateKey searches the key store for a given kid and
