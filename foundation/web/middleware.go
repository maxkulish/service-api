...
// after another Handler. It is designed to remove boilerplate or
// other concerns not direct to any given Handler
...
func wrapMiddleware(mw []Middleware, handler Handler) Handler {
	...
	// of the slice is the first to be executed by request
