...
import (
	"context"
	_ "embed" // Calls init function to register embedded files.
	"fmt"

	"github.com/jmoiron/sqlx"
	"github.com/maxkulish/darwin/v2"
...
// with the migrations defined in this package.
...
// DeleteAll runs the set of Drop-table queries against db.
